<?php $__env->startSection('content'); ?>
    <div class="container mx-auto py-8 px-4 max-w-7xl">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-800 mb-2">Welcome Back, <?php echo e(explode(' ', Auth::user()->name)[0]); ?>!</h1>
                <p class="text-gray-600"><?php echo e(Auth::user()->name); ?></p>
            </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900">
                            <?php echo e($events->where('registration_phase', '!=', 'closed')->count()); ?>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900"><?php echo e($totalEvents); ?></p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">
                            V: <?php echo e($pendingVolunteers); ?> • P: <?php echo e($pendingParticipants); ?>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-yellow-700">
                        You have <?php echo e($totalPending); ?> applications waiting for review
                        <?php if($pendingVolunteers > 0): ?>
                            (<?php echo e($pendingVolunteers); ?> volunteers<?php echo e($pendingParticipants > 0 ? ', ' . $pendingParticipants . ' participants' : ''); ?>)
                        <?php elseif($pendingParticipants > 0): ?>
                            (<?php echo e($pendingParticipants); ?> participants)
                        <?php endif; ?>
                    </p>
                </div>
                <div class="flex space-x-3">
                    <?php if($pendingVolunteers > 0): ?>
                        <span class="inline-flex items-center px-3 py-2 rounded-md text-sm font-medium bg-yellow-100 text-yellow-800">
                            <?php echo e($pendingVolunteers); ?> Volunteers Pending
                        </span>
                    <?php endif; ?>
                    <?php if($pendingParticipants > 0): ?>
                        <span class="inline-flex items-center px-3 py-2 rounded-md text-sm font-medium bg-yellow-100 text-yellow-800">
                            <?php echo e($pendingParticipants); ?> Participants Pending
                        </span>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-md">
            ...
            <div class="px-6 py-3 bg-gray-50 border-b border-gray-200">
                <div class="flex items-center justify-between text-sm text-gray-600">
                    <span id="eventsCount">Showing <?php echo e($events->count()); ?> of <?php echo e($events->count()); ?> events</span>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200" id="eventsTableBody">
                        <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 event-row" 
                                ...
                                data-location="<?php echo e(strtolower($event->location)); ?>"
                                data-status="<?php echo e($event->registration_phase); ?>"
                                data-date="<?php echo e($event->date); ?>"
                                data-pending="<?php echo e($event->eventRegistrations->where('status', 'pending')->count() + 
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                    ...
                                    <div class="text-xs text-gray-400">
                                        <?php echo e(\Carbon\Carbon::parse($event->date)->diffForHumans()); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <?php elseif($event->registration_phase === 'closed'): ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <?php if($totalEventPending > 0 || $eventInterviewVolunteers > 0): ?>
                                        <div class="flex flex-col space-y-1">
                                            <?php if($eventPendingVolunteers > 0): ?>
                                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                                    V: <?php echo e($eventPendingVolunteers); ?> pending
                                                </span>
                                            <?php endif; ?>
                                            <?php if($eventInterviewVolunteers > 0): ?>
                                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                    V: <?php echo e($eventInterviewVolunteers); ?> interview
                                                </span>
                                            <?php endif; ?>
                                            <?php if($eventPendingParticipants > 0): ?>
                                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                                    P: <?php echo e($eventPendingParticipants); ?> pending
                                                </span>
                                            <?php endif; ?>
                                        </div>
                                    <?php else: ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php if(Auth::user()->isSuperAdmin() || $event->users->contains(Auth::id())): ?>
                                        <div class="flex flex-col space-y-2">
                                            <!-- Management Links -->
                                            <div class="flex space-x-2">
                                                <a href="<?php echo e(route('admin.manage-volunteers', $event->id)); ?>"
                                                    class="inline-flex items-center px-2 py-1 text-xs bg-blue-100 text-blue-700 rounded hover:bg-blue-200 transition">
                                                    Volunteers
                                                    <?php if($eventPendingVolunteers > 0): ?>
                                                        <span class="ml-1 bg-yellow-500 text-white rounded-full px-1 text-xs"><?php echo e($eventPendingVolunteers); ?></span>
                                                    <?php endif; ?>
                                                </a>

                                                <a href="<?php echo e(route('admin.participants', $event->id)); ?>"
                                                    class="inline-flex items-center px-2 py-1 text-xs bg-green-100 text-green-700 rounded hover:bg-green-200 transition">
                                                    Participants
                                                    <?php if($eventPendingParticipants > 0): ?>
                                                        <span class="ml-1 bg-yellow-500 text-white rounded-full px-1 text-xs"><?php echo e($eventPendingParticipants); ?></span>
                                                    <?php endif; ?>
                                                </a>
                                            </div>
                                            
                                            <!-- Status Update -->
                                            <form method="POST" action="<?php echo e(route('admin.update-event-status', $event->id)); ?>" class="inline-block">
                                                <?php echo csrf_field(); ?>
                                                <select name="status" onchange="this.form.submit()"
                                                    class="text-xs border border-gray-300 rounded px-2 py-1 w-full">
                                                    <option value="volunteer_open" <?php echo e($event->registration_phase === 'volunteer_open' ? 'selected' : ''); ?>>
                                                        Volunteer Open
                                                    </option>
                                                    <option value="participant_open" <?php echo e($event->registration_phase === 'participant_open' ? 'selected' : ''); ?>>
                                                        Participant Open
                                                    </option>
                                                    <option value="closed" <?php echo e($event->registration_phase === 'closed' ? 'selected' : ''); ?>>
                                                        Closed
                                                    </option>
                                                    <option value="completed" <?php echo e($event->registration_phase === 'completed' ? 'selected' : ''); ?>>
                                                        Completed
                                                    </option>
                                                </select>
                                            </form>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                <div class="flex items-center justify-between">
                    <div class="text-sm text-gray-700">
                        Showing <span class="font-medium" id="showingStart">1</span> to <span class="font-medium" id="showingEnd"><?php echo e(min(25, $events->count())); ?></span> of <span class="font-medium" id="totalItems"><?php echo e($events->count()); ?></span> results
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Petra Campus Event\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>